    ...
    <div className="w-full h-[85vh] bg-gray-900">
      <div className="grid grid-cols-1 md:grid-cols-3 h-full gap-1">
        ...
        >
          ...
          <div className="relative z-10 flex flex-col justify-end h-full p-6 text-white">
            <div className="flex items-center space-x-2 mb-2">
              <span className="bg-opacity-70 p-1 rounded">
                {getIcon(heroData.sections[0].type)}
              </span>
              <span className="uppercase text-xs font-serif italic">
                {heroData.sections[0].type}
              </span>
            </div>
        ...
        <div className="flex flex-col h-full gap-1">
          {[1, 2].map((i) => {
            const section = heroData.sections[i];
